...
class parser():
    def __init__(self, code): #input code
        ...
        self.TT_CALL = "CALL"
        self.TT_IF = "IF"
        self.TT_STATEMENT = "STATEMENT"
        self.TT_END_STATEMENT = "END_STATEMENT"
    def parse(self): #this parses the code
        ...
        while cursor < len(self.code):
            ...
            if letter == ";": #checks the end of line
                ...
                self.parse_result.append(value.strip(";").strip("}")) #for 'Call' add '}' at the last
                cursor += jump
                ...
                if word == "Class": #when the word is Class
                    ...
                    while self.code[jump + cursor] != "{":
                        jump += 1
                        statement += self.code[jump + cursor]
